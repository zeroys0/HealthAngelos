...
public class ScrollerNumberPicker extends View {
    ...
    private ArrayList<String> dataListID = new ArrayList<String>();
    /** 按下的坐标 */
    private int downY;
    /** 按下的时间 */
    ...
    private void initData() {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            itmItemObject.c_id = dataListID.get(i);
            itmItemObject.x = 0;
     ...
     * @param data
     */
    public void setData(ArrayList<String> data, ArrayList<String> dataListID) {
        this.dataList = data;
