...
//        cityPicker.setEnable(false);
        ...
        provincePicker.setData(citycodeUtil.getProvince(province_list), citycodeUtil.getProvince_list_code());
        provincePicker.setDefault(1);
        cityPicker.setData(citycodeUtil.getCity(city_map, citycodeUtil.getProvince_list_code().get(1)), citycodeUtil.getCity_list_code());
        ...
        cityPicker.setOnSelectListener(new ScrollerNumberPicker.OnSelectListener() {
            ...
            public void endSelect(int id, String text) {
                ...
                if (temCityIndex != id) {
                    ...
                    if (selectMonth == null || selectMonth.equals(""))
                        return;
                    counyPicker.setData(citycodeUtil.getCouny(couny_map, citycodeUtil.getCity_list_code().get(id)), citycodeUtil.getCouny_list_code());
                    counyPicker.setDefault(1);
