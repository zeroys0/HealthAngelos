                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            if (json.getInt("status") == 200) {
                                ...
                                Gson gson = new Gson();
                                List<HrBean> list = gson.fromJson(jsonArray.toString(),new TypeToken<List<HrBean>>(){}.getType());
                                setData(list);
...
//        mValues.add(new Entry(0f, dataList.get(0).getHr()));
//        mValues.add(new Entry(1f, dataList.get(1).getHr()));
//        mValues.add(new Entry(2f, dataList.get(2).getHr()));
//        mValues.add(new Entry(3f, dataList.get(3).getHr()));
//        mValues.add(new Entry(4f, dataList.get(4).getHr()));
//        mValues.add(new Entry(5f, dataList.get(5).getHr()));
//        mValues.add(new Entry(6f, dataList.get(6).getHr()));
