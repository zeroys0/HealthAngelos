...
public class AppFakeDataProvider {
    ...
    public static List<HeartRateData> fakeHeartRate(Context context) {
        ...
        long startTime = Utils2.getDayStartTime(calendar, new Date()).getTime();//Today start time
    ...
    public static List<SleepData> fakeSleepRecord() {
        ...
        Calendar calendar = Calendar.getInstance();
        Date todayStartTime = Utils2.getDayStartTime(calendar, new Date());//Today start time
        ...
        Date yesterdayStartTime = Utils2.getExpireLimitTime(calendar, 1);
