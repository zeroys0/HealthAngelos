...
public class Bind60flRadarActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bind60fl_radar);
        context = this;
        init();
    }
    ...
    public void bind(){
        OkGo.<String>post(Urls.getInstance().R60FL_BIND)
                .tag(this)
                .headers("token", MyApplication.token)
                .params("elderlyId", MyApplication.userInfo.getOlderlyId())
                .params("imei",ed_imei.getText().toString())
