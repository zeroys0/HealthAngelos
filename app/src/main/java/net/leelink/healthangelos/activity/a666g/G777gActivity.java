...
public class G777gActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g777g);
        context = this;
        init();
    }
    ...
    public void bind(){
        ...
        OkGo.<String>post(Urls.getInstance().BINDAALB)
                .tag(this)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            Log.d("绑定爱奥乐血糖仪设备", json.toString());
