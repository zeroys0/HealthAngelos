...
public class BloodOxygenActivity extends BaseActivity {
    ...
    void setWeb(String url) {
        if (agentweb == null) {
            agentweb = AgentWeb.with(BloodOxygenActivity.this)
        ...
        mTestingHealthyDisposable = mWristbandManager
                ...
                .subscribe(new Consumer<HealthyDataResult>() {
                    ...
                    public void accept(HealthyDataResult result) throws Exception {
                        ...
                        Log.d("血氧数据: ", getString(R.string.oxygen_value, result.getOxygen()));
                        oxygen = result.getOxygen();
...
//                            mTvRespiratoryRate.setText(getString(R.string.respiratory_rate_value, result.getRespiratoryRate()));
    ...
    private void popu_head() {
        ...
        popview = LayoutInflater.from(BloodOxygenActivity.this).inflate(R.layout.popu_fit_health, null);
        ...
        popuPhoneW.setOnDismissListener(new BloodOxygenActivity.poponDismissListener());
    }
