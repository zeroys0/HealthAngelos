...
public class JWatchBBloodOxygenActivity extends BaseActivity implements View.OnClickListener {
    private Context context;
    private RelativeLayout rl_back,rl_rate_set;
    private TextView tv_data,tv_blood_oxygen,tv_rate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jwatch_bblood_oxygen);
        context =this;
        init();
        initData();
    }
                    ...
                    public void onSuccess(Response<String> response) {
                        try {
                            ...
                            if (json.getInt("status") == 200) {
                                ...
                                tv_blood_oxygen.setText(json.getString("o"));
                                if (!json.isNull("hrt")) {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.rl_back:
                ...
                break;
            case R.id.tv_data:
                Intent intent = new Intent(context,JWatchBBloodOxygenHistoryActivity.class);
                startActivity(intent);
                break;
            case R.id.btn_get_data:     //发送测量指令
                setRate(1);
                if (task == null) {
                    task = new MyTask();
                    timer = new Timer();
