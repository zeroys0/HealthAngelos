...
public class A666gMainActivity extends BaseActivity implements View.OnClickListener, OnOrderListener {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            if (json.getInt("status") == 200) {
                                ...
                                a6gBldPressureAdapter = new A6gBldPressureAdapter(context,list,A666gMainActivity.this);
