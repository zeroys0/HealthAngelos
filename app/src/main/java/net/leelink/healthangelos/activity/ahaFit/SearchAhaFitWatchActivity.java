...
public class SearchAhaFitWatchActivity extends BaseActivity implements OnOrderListener {
    ...
    public void showpop(){
        ...
        pop.setOnDismissListener(new SearchAhaFitWatchActivity.poponDismissListener());
    ...
    public void onItemClick(View view) {
        ...
        Intent intent = new Intent(context, BindAhaFitWatchActivity.class);
