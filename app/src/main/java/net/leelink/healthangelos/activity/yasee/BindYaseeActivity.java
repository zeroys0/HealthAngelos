...
public class BindYaseeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bind_yasee);
        context = this;
        init();
    ...
    public void bind(){
        ...
        OkGo.<String>post(Urls.getInstance().YASEE_BIND)
                .tag(this)
