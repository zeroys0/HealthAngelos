...
public class FitHeartRateActivity extends BaseActivity {
    ...
    void setWeb(String url) {
        if (agentweb == null) {
            agentweb = AgentWeb.with(FitHeartRateActivity.this)
...
//                          mBtnTestHealthy.setText(R.string.real_time_data_start);
                ...
                .subscribe(new Consumer<HealthyDataResult>() {
                    ...
                    public void accept(HealthyDataResult result) throws Exception {
                        ...
                        Log.d("心率数据: ", getString(R.string.heart_rate_value, result.getHeartRate()));
    ...
    private void popu_head() {
        ...
        popview = LayoutInflater.from(FitHeartRateActivity.this).inflate(R.layout.popu_fit_health, null);
        ...
        popuPhoneW.setOnDismissListener(new FitHeartRateActivity.poponDismissListener());
    }
