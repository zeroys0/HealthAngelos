...
public class YaseeAcidActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yasee_acid);
        context = this;
    ...
    public void initData(String date) {
        OkGo.<String>get(Urls.getInstance().YASEE_ACID)
                .tag(this)
...
//        leftAxis.setTextColor(Color.parseColor("#656565"));   //设置字体颜色
        ...
        LineDataSet set1 = new LineDataSet(mValues,"尿酸");
