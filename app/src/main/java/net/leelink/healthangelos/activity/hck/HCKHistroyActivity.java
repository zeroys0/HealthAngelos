...
public class HCKHistroyActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void init(){
        ...
        HCKHistroyActivity.SpacesItemDecoration decoration = new HCKHistroyActivity.SpacesItemDecoration(16);
