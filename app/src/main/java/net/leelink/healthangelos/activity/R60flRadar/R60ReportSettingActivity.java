...
public class R60ReportSettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private SwitchCompat cb_work_time, cb_out_board, cb_body, cb_sport_info, cb_sport_param, cb_body_range, cb_body_direction;
                        ...
                        try {
                            ...
                            if (json.getInt("status") == 200) {
                                ...
                                if(!json.isNull("movementSigns")){
                                    if(json.getInt("movementSigns")==0){
                                ...
                                if(!json.isNull("humanDistance")){
                                    if(json.getInt("humanDistance")==0){
                                ...
                                if(!json.isNull("humanPosition")){
                                    if(json.getInt("humanPosition")==0){
