...
public class AhaFitTemperatureActivity extends BaseActivity {
    ...
    void setWeb(String url) {
        if (agentweb == null) {
            agentweb = AgentWeb.with(AhaFitTemperatureActivity.this)
...
//                          mBtnTestHealthy.setText(R.string.real_time_data_start);
    ...
    private void popu_head() {
        ...
        popview = LayoutInflater.from(AhaFitTemperatureActivity.this).inflate(R.layout.popu_fit_health, null);
        ...
        popuPhoneW.setOnDismissListener(new AhaFitTemperatureActivity.poponDismissListener());
    }
    /**
