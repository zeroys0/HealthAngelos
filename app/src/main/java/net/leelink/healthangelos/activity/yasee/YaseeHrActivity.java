...
public class YaseeHrActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yasee_hr);
        context = this;
    ...
    public void setData(List<YaseeBpBean> dataList){
...
//        List<String> day_list = getDays();
        ...
        //获取数据时间列表
        Date[] dates = list.toArray(new Date[0]);
...
//        leftAxis.setTextColor(Color.parseColor("#656565"));   //设置字体颜色
        ...
        for(int i =0;i<dataList.size();i++) {
            mValues.add(new Entry((float) i, dataList.get(i).getHeartRate()));
        }
