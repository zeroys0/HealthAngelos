...
public class MyDeviceAdapter  extends RecyclerView.Adapter<MyDeviceAdapter.ViewHolder>{
    ...
    public MyDeviceAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MyDeviceAdapter.ViewHolder viewHolder = new MyDeviceAdapter.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull MyDeviceAdapter.ViewHolder holder, int position) {
        try {
            if (jsonArray.getJSONObject(position).has("imgPath")) {
            ...
            holder.tv_detail.setText(jsonArray.getJSONObject(position).getString("imei"));
